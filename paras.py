...
parser.add_argument('--input_data_dir', type=str, default='/home/chendingshuo/graphmvp/datasets/')
...
parser.add_argument('--input_model_file', type=str, default='../runs/net2D_model.pth')
